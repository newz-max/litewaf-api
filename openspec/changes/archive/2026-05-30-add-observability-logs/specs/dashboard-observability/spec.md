...
The dashboard SHALL provide an attack log page backed by the attack log API.
...
The dashboard SHALL display traffic and protection metrics using real summary API data.
